        ...
        <div class="load">
            ...
            <div>
                ...
                <div class="back-btn d-flex justify-content-center">
                    <a class="back btn d-none" href="<?php echo e(url('/install/info')); ?>">Try Again</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        <option value="install" class="install_option"><?php echo e(__('I Want To Install')); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="migrate_url" value="<?php echo e(url('/install/migrate')); ?>">
                                    <input type="hidden" id="seed_url" value="<?php echo e(url('/install/seed')); ?>">
                                    <input type="hidden" id="check_url" value="<?php echo e(url('/install/check')); ?>">
...
<?php /**PATH /Volumes/my-works/laravel/multipayent/script/resources/views/installer/info.blade.php ENDPATH**/ ?>