<?php if(isset($data['headings']['heading.integration'])): ?>
    <?php
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="sass-text mb-50">
                        ...
                        <a class="hero-btn two mt-50" href="<?php echo e($heading['button_url'] ?? null); ?>">
...
curl --location --request POST <?php echo e($url); ?>'/api/payment/create' \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => <?php echo e($url); ?>'/api/payment/create',
...
<?php echo e('<form method="POST" action="'.$url.'/api/payment/merchant/create" >
...
var options = {
  'method': 'POST',
  'url': <?php echo e($url); ?>'/api/payment/create',
  'headers': {
  },
  formData: {
    'token': 'MERCHANT_KEY',
...
url = URI(<?php echo e($url); ?>"/api/payment/create")
...
<?php endif; ?>
<?php /**PATH /Volumes/my-works/laravel/multipayent/script/resources/views/frontend/home/integration.blade.php ENDPATH**/ ?>