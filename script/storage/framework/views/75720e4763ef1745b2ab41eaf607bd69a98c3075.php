<div class="row my-4 mb-5 mt-5">
    <div class="col-lg-12">
        <div class="row justify-content-between mt-3 mb-4">
            <div class="col">
                <h3><?php echo e(__('Qr Payments')); ?></h3>
            </div>
            <div class="col-sm-4">
...
<input type="hidden" id="get-qr-payments-data" value="<?php echo e(route('user.qr-payments.chart')); ?>">
<?php /**PATH /Volumes/my-works/laravel/multipayent/script/resources/views/user/dashboard/charts/qr-payments.blade.php ENDPATH**/ ?>