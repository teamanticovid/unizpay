<div class="row my-4 mb-5">
    <div class="col-lg-12">
        <div class="row justify-content-between mt-3 mb-4">
            <div class="col">
                <h3><?php echo e(__('Credit/Debit')); ?></h3>
            </div>
            <div class="col-sm-4">
        ...
        <canvas id="myChart" height="300" width="864" class="chartjs-render-monitor"></canvas>
    </div>
</div>
<?php /**PATH /Volumes/my-works/laravel/multipayent/script/resources/views/user/dashboard/charts/debit-credit.blade.php ENDPATH**/ ?>