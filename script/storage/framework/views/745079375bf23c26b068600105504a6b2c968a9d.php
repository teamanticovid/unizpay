...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Active Website/Merchant')); ?></h4>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Total Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Single Charge Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Invoice Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Qr Payment Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Donation Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Website Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Money Transfer Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Money Request Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(__('Payout Earning of :year', ['year' => date('Y')])); ?></h4>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-header-title"><?php echo e(__('Earnings performance')); ?> <img
                                src="<?php echo e(asset('uploads/loader.gif')); ?>" height="20" id="earning_performance"></h4>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('Site Analytics')); ?></h4>
                    <div class="card-header-action">
                ...
                <div class="card-body">
                    ...
                    <div class="statistic-details mt-sm-4">
                        <div class="statistic-details-item">
                            ...
                            <div class="detail-name"><?php echo e(__('Total Visitors')); ?></div>
                        </div>
                        <div class="statistic-details-item">

                            <div class="detail-value" id="total_page_views"></div>
                            <div class="detail-name"><?php echo e(__('Total Page Views')); ?></div>
                        </div>

                        <div class="statistic-details-item">

                            <div class="detail-value" id="new_vistors"></div>
                            <div class="detail-name"><?php echo e(__('New Visitor')); ?></div>
                        </div>

                        <div class="statistic-details-item">

                            <div class="detail-value" id="returning_visitor"></div>
                            <div class="detail-name"><?php echo e(__('Returning Visitor')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><?php echo e(__('Referral URL')); ?></h4>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4><?php echo e(__('Top Browser')); ?></h4>
                        </div>
                        <div class="card-body">
    ...
    <input type="hidden" id="dashboard_performance" value="<?php echo e(url('/admin/dashboard/performance')); ?>">
    ...
    <input type="hidden" id="defaultCurrency" value="<?php echo e(default_currency('code')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('admin/plugins/chatjs/Chart.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/jquerysparkline/jquery.sparkline.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/pages/dashboard.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/multipayent/script/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>